...
interface ICustomGateway {
    /**
     * Initiates an ERC20 token transfer between Ethereum and metachain using the registered or otherwise default gateway
     ...
     * @return res abi encoded inbox sequence number in case of deposits (L1->L2) or id from METASys call in case of withdrawals (L2->L1)
     */
