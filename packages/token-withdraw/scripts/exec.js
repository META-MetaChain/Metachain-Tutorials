...
const main = async () => {
  await METALog('Withdraw token using metachain SDK')
   ...
   * This transaction is constructed and paid for like any other L2 transaction (it just happens to (ultimately) make a call to METASys.sendTxToL1)
   * Arguments required are:
