...
} = require('@metachain/sdk/dist/lib/message/L1ToL2MessageGasEstimator')
...
const { getBaseFee } = require('@metachain/sdk/dist/lib/utils/lib')
...
const main = async () => {
  await METALog('Cross-chain Greeter')
  ...
  /**
   * Use l2Network to create an metachain SDK EthBridger instance
  ...
  /**
   * Now we can query the required gas params using the estimateAll method in metachain SDK
   */
