...
import "@metachain/nitro-contracts/src/precompiles/METASys.sol";
import "@metachain/nitro-contracts/src/libraries/AddressAliasHelper.sol";
import "../Greeter.sol";

contract GreeterL2 is Greeter {
    METASys constant METAsys = METASys(address(100));
    ...
    function setGreetingInL1(string memory _greeting) public returns (uint256) {
        ...
        uint256 withdrawalId = METAsys.sendTxToL1(l1Target, data);
