...
import { addDefaultLocalNetwork } from "@metachain/sdk";
import { NodeInterface__factory } from "@metachain/sdk/dist/lib/abi/factories/NodeInterface__factory";
import { NODE_INTERFACE_ADDRESS } from "@metachain/sdk/dist/lib/dataEntities/constants";
const { requireEnvVariables } = require('META-shared-dependencies');
...
const destinationAddress = "0x03d49b54FbB71476FaaEB885BEa301086A92e0a6";

// The input data of the transaction, in hex. You can find examples of this information in metachain,
...
const gasEstimator = async () => {
    ...
    // ********************************************
    // P (L2 Gas Price) =>
    //      METAGasInfo.getPricesInWei() and get the sixth element => result[5]
    ...
    //      METAGasInfo.getL1BaseFeeEstimate() and multiply by 16
    //      METAGasInfo.getL1GasPriceEstimate() and multiply by 16
    //      METAGasInfo.getPricesInWei() and get the second element => result[1]
