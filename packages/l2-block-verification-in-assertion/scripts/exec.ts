...
import { RollupCore__factory } from "@metachain/sdk/dist/lib/abi/factories/RollupCore__factory"
import { METALog, requireEnvVariables } from 'META-shared-dependencies'
...
const main = async (l2BlockNumberToVerify: number) => {
  await METALog('Find whether an L2 block has been processed as part of an RBlock')
