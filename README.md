...
This monorepo will help you get started with building on metachain. It provides various simple demos showing and explaining how to interact with metachain — deploying and using contracts directly on L2, moving Ether and tokens betweens L1 and L2, and more.

We show how you can use broadly supported Ethereum ecosystem tooling (Hardhat, Ethers-js, etc.) as well as our special [metachain SDK](https://github.com/META-MetaChain/metachain-sdk) for convenience.
...
- ®️ [META Address Table](./packages/address-table/)
